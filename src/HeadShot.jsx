  ...
  return (
    <>
      ...
      >
        ...
        {/* headshot circle */}
        <div
          className={`transition-all relative shadow-mantle shadow  size-36 rounded-full bg-mauve border-mantle border-2 cursor-pointer animate-[startHead_1s_ease-in-out]
